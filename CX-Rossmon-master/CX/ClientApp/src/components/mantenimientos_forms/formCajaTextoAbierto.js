...
const CajaTextoAbierto = ({ data, proceso, onClickProcesarPregunta, onClickProcesarRespuestasPregunta, volverPasoDos, varIdTipoIndicador,
            ...
            <Card style={{ marginTop: 1 }}>
                <Card.Body>
                    <Form noValidate validated={validated} onSubmit={onClickAceptar}>
                        ...
                        <TextArea placeholder="" value="Mi respuesta Caja de Texto Abierto" />
